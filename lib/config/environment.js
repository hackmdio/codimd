...
module.exports = {
  sourceURL: process.env.HMD_SOURCE_URL,
  domain: process.env.HMD_DOMAIN,
  urlPath: process.env.HMD_URL_PATH,
  host: process.env.HMD_HOST,
  port: toIntegerConfig(process.env.HMD_PORT),
  path: process.env.HMD_PATH,
  loglevel: process.env.HMD_LOGLEVEL,
  ...
  forbiddenNoteIDs: toArrayConfig(process.env.HMD_FORBIDDEN_NOTE_IDS),
  ...
  s3: {
    ...
    endpoint: process.env.HMD_S3_ENDPOINT
  },
  minio: {
  ...
  oauth2: {
    providerName: process.env.HMD_OAUTH2_PROVIDERNAME,
  ...
  plantuml: {
    server: process.env.HMD_PLANTUML_SERVER
  },
  ...
  openID: toBooleanConfig(process.env.HMD_OPENID)
}
