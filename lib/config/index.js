...
const configFilePath = path.resolve(appRootPath, process.env.HMD_CONFIG_FILE ||
'config.json')
...
if (config.serverURL === '') {
  logger.warn('Neither \'domain\' nor \'HMD_DOMAIN\' is configured. This can cause issues with various components.\nHint: Make sure \'protocolUseSSL\' and \'urlAddPort\' or \'HMD_PROTOCOL_USESSL\' and \'HMD_URL_ADDPORT\' are configured properly.')
}
