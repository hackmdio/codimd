...
var adoc = require('asciidoctor.js')()
  ...
  var Note = sequelize.define('Note', {
    ...
    classMethods: {
      ...
      parseNoteInfo: function (body) {
        ...
        var doc = adoc.load(parsed.markdown,{ attributes: {showtitle: true}})
        return {
          title: Note.extractNoteTitle(parsed.meta, doc),
      ...
      parseNoteTitle: function (body) {
        var parsed = Note.extractMeta(body)
        var doc = adoc.load(parsed.markdown,{ attributes: {showtitle: true}})
	return Note.extractNoteTitle(parsed.meta, doc)
      },
      extractNoteTitle: function (meta, doc) {
	return doc.getHeader().title
      },
