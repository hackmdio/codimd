...
const { newCheckViewPermission, checkViewPasswordPermission, errorIncorrectPassword, errorNeedPassword, errorForbidden, responseCodiMD, errorNotFound, errorInternalError } = require('../response')
...
async function showNote (req, res) {
  ...
  if (note.permission === 'password') {
    if (!checkViewPasswordPermission(req, note)) {
