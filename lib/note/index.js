...
const { newCheckViewPermission, checkPasswordInSession, errorNeedPassword, errorForbidden, responseCodiMD, errorNotFound, errorInternalError } = require('../response')
...
async function tryNotePassword (req, res) {
  ...
  // TODO: use password from database
